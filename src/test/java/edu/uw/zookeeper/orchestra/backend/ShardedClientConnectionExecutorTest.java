...
public class ShardedClientConnectionExecutorTest {
    ...
    public void test() throws InterruptedException, ExecutionException {
        ...
        ListenableFuture<Pair<Message.ClientRequest<?>, Message.ServerResponse<?>>> clientFuture = client.submit(Operations.Requests.getChildren().setPath(volume.getDescriptor().getRoot()).build());

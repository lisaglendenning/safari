...
public class JacksonModule extends SimpleModule {
    ...
    static {
        try {
            MAVEN_PROPS.load(JacksonModule.class.getClassLoader().getResourceAsStream("META-INF/maven/edu.uw.zookeeper/orchestra/pom.properties"));
        } catch (Exception e) {
        }
    }
    public static final String MAVEN_VERSION = MAVEN_PROPS.getProperty("version", DEFAULT_VERSION);
    public static final String PROJECT_NAME = "Orchestra";

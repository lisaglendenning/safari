...
public final class PrepareVolumeOperation<O extends Operation.ProtocolResponse<?>> implements Function<List<ListenableFuture<?>>,Optional<? extends ListenableFuture<?>>> {
    ...
    public static final class LookupParent implements Function<List<ListenableFuture<?>>,Optional<? extends ListenableFuture<?>>> {
    ...
    public static final class LookupPrefix implements Function<List<ListenableFuture<?>>, Optional<? extends ListenableFuture<?>>> {
